...
#include <sesto_payload/SlideDoor.hpp>
...
MotorController::MotorController() : Node("motor_controller_wrap")
{
    ...
    gpio_setup();
    door_num_subscription_ = this->create_subscription<std_msgs::msg::Int8>("door_control_command", std::bind(&MotorController::door_control_command_callback, this, _1));
